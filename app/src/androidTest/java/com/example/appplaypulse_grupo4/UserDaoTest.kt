...
class UserDaoTest {
    ...
    fun insertUser_returnsCorrectId() = runTest {
        val user = User(username = "testuser", email = "test@example.com", nombre = "Testin", apellido = "Teston", edad = 11, phone = "+56912345678", password = "1234")
    ...
    fun getUserById_returnsCorrectUser() = runTest {
        val user = User(username = "testuser", email = "test@example.com", nombre = "Testin", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234")
        val userId = userDao.insertUser(user)
    ...
    fun updateUserHighScore_updatesCorrectly() = runTest {
        val user = User(username = "testuser", email = "test@example.com", highScore = 100, nombre = "Testin", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234")
        val userId = userDao.insertUser(user)
    ...
    fun getTopUsers_returnsInDescendingOrder() = runTest {
        ...
        userDao.insertUser(User(username = "user1", email = "user1@test.com", highScore = 300, nombre = "Testin1", apellido = "Teston", edad = 10, phone = "+56912345678", password = "1234"))
        userDao.insertUser(User(username = "user2", email = "user2@test.com", highScore = 500, nombre = "Testin2", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234"))
        userDao.insertUser(User(username = "user3", email = "user3@test.com", highScore = 100, nombre = "Testin3", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234"))
    ...
    fun deleteAllUsers_clearsDatabase() = runTest {
        // Insert test users
        userDao.insertUser(User(username = "user1", email = "user1@test.com", nombre = "Testin1", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234"))
        userDao.insertUser(User(username = "user2", email = "user2@test.com", nombre = "Testin2", apellido = "Teston", edad = 36, phone = "+56912345678", password = "1234"))
